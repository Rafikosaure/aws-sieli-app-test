...
const connection = new Sequelize(
    'la-foire-mysql', // Nom de la base de donnée
    'admin', // identifiant Mysql
    'ofhsFNJNVKLJI', // Mot de passe Mysql
    {
        host: 'sieli-database-01.ct6q4oeqo4gp.us-east-1.rds.amazonaws.com', // URL de mySQL
        dialect: 'mysql'
    }
);
